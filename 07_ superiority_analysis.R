...
anova(nb_superiority_old,
      nb_superiority,
      test = "LRT")

wilcox_test_result <- wilcox.test(fi_each ~ pval_significance, data = model_superiority, exact = FALSE)
wilcox_test_result
#--------------------------------------------------
...
# Calculate VIF
vif_values <- car::vif(nb_superiority)
...
writexl::write_xlsx(
  vif_table,
  "outputs/tables/VIF_superiority_model.xlsx"
)
# ------------------------------------------------------------
# Export results
# ------------------------------------------------------------
